...
This top-level README shows both **TypeScript** and **Python** paths. The Python-first guide lives in [python/README.md](/home/mod/Code/plat/python/README.md).
...
- TypeScript client call: `client.createOrder({ itemId: "...", qty: 2 })`
- Python client call: `client.createOrder(itemId="...", qty=2)`
...
plat supports both TypeScript and Python as first-class runtimes.

- TypeScript
  - controller decorators
  - dynamic and generated clients
  - browser, Node, Bun, CLI, and AI-tool integrations
  - curated examples under [typescript/](/home/mod/Code/plat/typescript)
- Python
  - controller decorators
  - OpenAPI generation from `*.api.py`
  - sync, async, and promise-style clients
  - deferred call handles, coercion, serialization, and named HTTP errors
  - Python-first guide in [python/README.md](/home/mod/Code/plat/python/README.md)
