...
export type Clientified<T> = {
    ...
    T[K] extends (input: infer I, ctx: any) => Promise<infer O>
        ? (input: I, opts?: ClientCallOptions) => Promise<O>
        : never
}
...
export interface ClientCallOptions {
    ...
    onRpcEvent?: (event: { id?: string; event: PLATRPCEventKind; data?: unknown }) => void | Promise<void>
}
