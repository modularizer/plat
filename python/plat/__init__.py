...
__all__ = [
    ...
    "create_authority_server_controller",
...
def __getattr__(name):
    if name in {
        ...
        exports = {
            ...
            "connect_async_client_side_server": connect_async_client_side_server,
    ...
    if name in {
        ...
        from .authority_server import AuthorityServerOptions, create_authority_server_controller

        exports = {
            "CSSAuthorityRecord": CSSAuthorityRecord,
            "CSSAuthorityKeyPair": CSSAuthorityKeyPair,
            "CSSAuthorityServer": CSSAuthorityServer,
            "CSSKnownHostRecord": CSSKnownHostRecord,
            "AuthorityServerOptions": AuthorityServerOptions,
            "create_authority_server_controller": create_authority_server_controller,
            "create_public_key_fingerprint": create_public_key_fingerprint,
            "create_signed_authority_record": create_signed_authority_record,
            "load_known_host": load_known_host,
            "load_known_hosts_json": load_known_hosts_json,
            "resolve_known_host_from_authorities": resolve_known_host_from_authorities,
            "save_known_host": save_known_host,
            "save_known_hosts_json": save_known_hosts_json,
            "trust_on_first_use": trust_on_first_use,
            "verify_authority_record": verify_authority_record,
            "verify_server_identity": verify_server_identity,
        }
        return exports[name]
